        ...
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 1 }}>
          ...
          <Grid style={{ overflowY: "scroll", overflowX: "hidden", maxHeight: "600px", paddingTop: 6 }}>
            ...
            <ButtonGroup sx={{ borderRadius: "0px !important",border:"none !important", }}>
              <Button sx={{ borderRadius: "0px !important" ,background:"#C8C7B5"}}>INCH</Button>
              <Button sx={{ borderRadius: "0px !important" }}>CM</Button>
            </ButtonGroup>
            <Grid sx={{xm:{overflowX:"scroll",width:"100%"}}}>
            <Typography sx={{background:"#C8C7B5",color:"black",padding:"4px 8px",fontSize:"14px",marginTop:"10px"}}>ِSize Chart (Travel wear , Kaftan & Dresses)</Typography>
            <TableContainer >
           ...
           <Typography sx={{background:"#C8C7B5",color:"black",padding:"4px 8px",fontSize:"14px",marginTop:"10px"}}>Abaya Size Guide</Typography>
            <TableContainer >
              <Table stickyHeader aria-label="sticky table">
                <TableHead>
                  <TableRow>
